...
- **[macOS (Universal)](https://github.com/jamdaniels/fing/releases/download/v1.2.1/Fing_1.2.1_universal.dmg)** — signed and notarized, open the DMG and move Fing to Applications
- **[Windows](https://github.com/jamdaniels/fing/releases/download/v1.2.1/Fing_1.2.1_x64-setup.exe)** — if SmartScreen warns you, click "More info" then "Run anyway"
